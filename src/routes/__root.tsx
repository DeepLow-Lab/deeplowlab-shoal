...
const SITE_URL = "https://deeplowlab.tech";
const SITE_NAME = "DeepLow Lab";
// Note: og-image.png should be a 1200x630 PNG for production.
// Create from official brand assets (icon-512.png as base).
const DEFAULT_OG_IMAGE = `${SITE_URL}/og-image.png`;
const TWITTER_HANDLE = "@deeplowlab";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Silkscreen:wght@400;700&family=Space+Grotesk:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
...
function RootShell({ children }: { children: ReactNode }) {
  const organizationSchema = {
    ...
    sameAs: [
      "https://github.com/deeplowlab",
      "https://twitter.com/deeplowlab",
    ],
    contactPoint: {
      "@type": "ContactPoint",
